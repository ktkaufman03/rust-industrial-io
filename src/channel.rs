...
pub enum ChannelType {
    Voltage = ffi::iio_chan_type_IIO_VOLTAGE as u32,
    Current = ffi::iio_chan_type_IIO_CURRENT as u32,
    Power = ffi::iio_chan_type_IIO_POWER as u32,
    Accel = ffi::iio_chan_type_IIO_ACCEL as u32,
    AnglVel = ffi::iio_chan_type_IIO_ANGL_VEL as u32,
    Magn = ffi::iio_chan_type_IIO_MAGN as u32,
    Ligtht = ffi::iio_chan_type_IIO_LIGHT as u32,
    Intensity = ffi::iio_chan_type_IIO_INTENSITY as u32,
    Proximity = ffi::iio_chan_type_IIO_PROXIMITY as u32,
    Temp = ffi::iio_chan_type_IIO_TEMP as u32,
    Incli = ffi::iio_chan_type_IIO_INCLI as u32,
    Rot = ffi::iio_chan_type_IIO_ROT as u32,
    Angl = ffi::iio_chan_type_IIO_ANGL as u32,
    Timestamp = ffi::iio_chan_type_IIO_TIMESTAMP as u32,
    Capacitance = ffi::iio_chan_type_IIO_CAPACITANCE as u32,
    AltVoltage = ffi::iio_chan_type_IIO_ALTVOLTAGE as u32,
    Cct = ffi::iio_chan_type_IIO_CCT as u32,
    Pressure = ffi::iio_chan_type_IIO_PRESSURE as u32,
    HumidityRelative = ffi::iio_chan_type_IIO_HUMIDITYRELATIVE as u32,
    Activity = ffi::iio_chan_type_IIO_ACTIVITY as u32,
    Steps = ffi::iio_chan_type_IIO_STEPS as u32,
    Energy = ffi::iio_chan_type_IIO_ENERGY as u32,
    Distance = ffi::iio_chan_type_IIO_DISTANCE as u32,
    Velocity = ffi::iio_chan_type_IIO_VELOCITY as u32,
    Concentration = ffi::iio_chan_type_IIO_CONCENTRATION as u32,
    Resistance = ffi::iio_chan_type_IIO_RESISTANCE as u32,
    Ph = ffi::iio_chan_type_IIO_PH as u32,
    UvIndex = ffi::iio_chan_type_IIO_UVINDEX as u32,
    ElectricalConductivity = ffi::iio_chan_type_IIO_ELECTRICALCONDUCTIVITY as u32,
    Count = ffi::iio_chan_type_IIO_COUNT as u32,
    Index = ffi::iio_chan_type_IIO_INDEX as u32,
    Gravity = ffi::iio_chan_type_IIO_GRAVITY as u32,
    Unknown = ffi::iio_chan_type_IIO_CHAN_TYPE_UNKNOWN as u32,
}
